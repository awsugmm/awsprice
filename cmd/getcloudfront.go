...
// getcloudfrontCmd represents the getcloudfront command
...
func init() {
	...
	// getcloudfrontCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// getcloudfrontCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
