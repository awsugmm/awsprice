...
// getelasticacheCmd represents the getelasticache command
...
func init() {
	...
	// getelasticacheCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// getelasticacheCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
